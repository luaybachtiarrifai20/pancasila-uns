...
import { 
  ArrowLeft, MessageSquare, Plus, Edit, Trash2, X,
  Clock, Globe, Save, Image, Video, Link2, Eye
} from 'lucide-react';
      ...
      <main className="max-w-5xl mx-auto p-4 sm:p-8">
        <div className="grid grid-cols-1 gap-6">
          {cases.map((cs) => (
            <div 
              key={cs.id} 
              className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 hover:shadow-xl hover:shadow-teal-100 transition-all duration-500 flex flex-col sm:flex-row sm:items-center gap-6 group"
            >
